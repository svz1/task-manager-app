            ...
            builder: (context, Box<TodoModel> todos, _){
              ...
              return ListView.separated(
                  itemBuilder:(_, index){
                    ...
                    return ListTile(
                      title: Text(todo.title, style: TextStyle(fontSize: 20,color:Colors.white),),
                
                      subtitle: Text(todo.detail,style: TextStyle(fontSize: 17,color:Colors.grey[500])),
                      leading: Text("$key",style: TextStyle(color:Colors.grey[400]),),
